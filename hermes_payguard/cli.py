...
def cmd_doctor(_: argparse.Namespace) -> int:
    ...
    state = {
        ...
        "default_chain": config.policy.default_chain,
        "circle_api_base_url": config.circle_api_base_url,
        "circle_cctp_api_base_url": config.circle_cctp_api_base_url,
        ...
        "cctp_executor_url": bool(config.cctp_executor_url),
